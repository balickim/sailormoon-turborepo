...
export default class BoatsApi {
  private readonly basePath = `${import.meta.env.VITE_API_URL}/boats`

  getBoats = async (params: IListParams = {}): Promise<IApiListResponse<unknown[]>> => {
